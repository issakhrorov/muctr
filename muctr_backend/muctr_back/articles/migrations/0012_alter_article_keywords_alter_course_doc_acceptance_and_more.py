...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('articles', '0011_alter_article_keywords'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='article',
            name='keywords',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=200, null=True), blank=True, default=list, size=10),
        ),
        migrations.AlterField(
            model_name='course',
            name='doc_acceptance',
